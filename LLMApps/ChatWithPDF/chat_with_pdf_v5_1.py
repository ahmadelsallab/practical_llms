...
def stream_chat_response(user_message, 
    ...
    message = message.format(message=user_message, extra_context=extra_context)
...
def main():
    ...
    if user_input:
        ...
        with st.spinner("Thinking..."):
            ...
            for response_chunk in stream_chat_response(user_message=user_input, 
                                                       chat_history=st.session_state.chat_history, 
                                                       extra_context=system_msg, 
